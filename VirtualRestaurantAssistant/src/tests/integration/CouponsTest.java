//
////---------- Just CTRL-A uncomment entire file
//
//
...
//		String expectedPassed = "Coupon added successfully!";
//		String expectedInvalid = "value must be between 10 and 100!";
//		String expectedDuplicate = "This discount value is already in the database!";
//		String expectedEmpty = "Input field is empty!";
//		
//		assertEquals(expectedPassed, coupon.addCoupon("20"));
//		assertEquals(expectedInvalid, coupon.addCoupon("9"));
//		assertEquals(expectedDuplicate, coupon.addCoupon("20"));
//		assertEquals(expectedEmpty, coupon.addCoupon(""));
//	}
//
//	@Test
