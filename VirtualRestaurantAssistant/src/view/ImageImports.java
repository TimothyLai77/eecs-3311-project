...
public class ImageImports {
	...
	protected static Image imgToToppings = new ImageIcon(HomePage.class.getResource("/res/toToppingsIcon.png")).getImage().getScaledInstance(200, 50, Image.SCALE_SMOOTH);
